...
class Othello:
    ...
    """
    def __init__(self, discs=[[3, 3, 1], [3, 4, 2], [4, 3, 2], [4, 4, 1]],offset=10, tile_size=80, line_width=4, line_color=(0,0,0), background_color=(255,255,255), disc_radius=30, disc_color_1=(0,0,255), disc_color_2=(255,165,0), A=[], active_player=1, legal_moves=[], players=['human', 'computer'], strategy=[]):
