...
class Othello:
    ...
    def check_board_pos(self, col, row):
        ...
        captured += self.check_west(col, row)
        captured += self.check_north(col, row)
        captured += self.check_south(col, row)
        captured += self.check_ne(col, row)
        captured += self.check_nw(col, row)
        captured += self.check_se(col, row)
        captured += self.check_sw(col, row)
        """
        return captured   
